 ...
 */
filesRouter.post('/files', xTokenAuthenticate, FilesController.postUpload);
 ...
 *  }
 */
filesRouter.get('/files/:id', xTokenAuthenticate, FilesController.getShow);
 ...
 *  ]
 */
filesRouter.get('/files', xTokenAuthenticate, FilesController.getIndex);
 ...
 *  }
 */
filesRouter.put('/files/:id/publish', xTokenAuthenticate, FilesController.putPublish);
 ...
 *  }
 */
filesRouter.put('/files/:id/unpublish', xTokenAuthenticate, FilesController.putUnpublish);

/**
 * @api {get} /files/:id/data Gets file data
 * @apiName GetFileData
 * @apiGroup Files
